...
public class BOJ_1992 {
    ...
    public static void split_conquer(int st_row, int st_col, int scan_size) { // 1 1 8 -> 5 1 4 -> 5 1 2
        if(scan_size == 1) {
            sb.append("(");
            sb.append(board[st_row][st_col]);
            sb.append(board[st_row][st_col + 1]);
            sb.append(board[st_row + 1][st_col]);
            sb.append(board[st_row + 1][st_col + 1]);
            sb.append(")");
            return;
        }
        sb.append("(");
    ...
    public static void scan(int st_row, int st_col, int scan_size) { // 5 1 4
        int cur_color = board[st_row][st_col];
